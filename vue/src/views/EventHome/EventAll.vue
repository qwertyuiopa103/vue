<template>
    <div class="container py-5">
      <!-- 活動列表 -->
      <div v-for="event in events" :key="event.eventID" class="row align-items-center event-block no-gutters margin-40px-bottom">
        <!-- 左側圖片區塊 -->
        <div :class="{'col-lg-5 col-sm-12': true, 'order-1 order-lg-2': event.eventID % 2 === 0}">
          <div class="position-relative">
            <div class="event-image-container">
              <img 
                :src="event.eventPicture || '/api/placeholder/450/280'" 
                alt="活動圖片"
                class="event-image"
              >
            </div>
